...
import { extractDomainDiff, compareDomains } from "$build/lib/diff.js";

// Mock the git operations module
vi.mock("$build/lib/git.js", () => ({
...
import { extractDomainsAtTag, extractFixedDomains } from "$build/lib/git.js";
